...
We support 2 types of authentication: Magic Link authentication and token authentication. Using the Magic Link is recommended to get started quickly.
...
Different E-commerce platforms require different token parameters:
