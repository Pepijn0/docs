---
title: 'Datamodels'
description: 'How Kariz uses Shopify's Datamodels'
---
...
| ------- | ---------- |
| Shopify | None |
| WooCommerce | No inventory location by default (store user needs to install [this add-on](https://wordpress.org/plugins/stock-locations-for-woocommerce/) to enable it) |
| BigCommerce | None |
| Lightspeed | None |
| Amazon | None |
| Bol | None |
...
<CardGroup>
  ...
  <Card title="Inventory Levels by Location" icon="map-marker-alt">
...
<CardGroup>
  ...
  <Card title="Refunds" icon="money-bill-wave">
