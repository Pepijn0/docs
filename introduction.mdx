---
title: "Introduction"
description: "Put E-commerce integrations on autopilot through Kariz's unified API"
---
...
Kariz offers unified APIs for E-commerce, based on the Shopify datamodels. We allow our customers to build a single integration to Kariz and instantly launch all E-commerce sales channel integrations to their customers.
...
This way, getting product data from any E-commerce platform like **Amazon** or **WooCommerce**  will look the same as getting product data from other E-commerce channels from **Shopify** . It's the same set of data models and fields you can rely on.
