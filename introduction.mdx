...
<CardGroup cols={2}>
  ...
  <Card title="User Token" icon="code" href="https://kariz-f9e6462a.mintlify.app/Authentication/Token-Authentication">
...
<CardGroup cols={2}>
  <Card title="Products & Inventory" icon="shirt" href="https://kariz-f9e6462a.mintlify.app/Products">
