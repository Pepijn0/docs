---
title: "Quickstart"
description: "Connect to E-commerce integrations in minutes"
---
...
\`\`\`
Authorization: Bearer ya29.a0AfH6SMDtYZB_...your_access_token...
\`\`\`
...
scopes=shopify,amazon,woocommerce (optional)
\`\`\`
...
tpUserId=customer123@example.com (required)
completionCallbackUrl=https://your-app.com/webhook (optional)
\`\`\`
...
<CardGroup cols={2}>
  ...
  <Card 
    ...
    icon="database" 
    href="/datamodels">
    Understand how our unified data structure works across platforms
  </Card>
  ...
  <Card 
    ...
    icon="store" 
    href="https://runkariz.com/integrations">
    View all the E-commerce channels we currently support
  </Card>
</CardGroup>`;
