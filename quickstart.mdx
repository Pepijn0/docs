...
If you haven't already, book a demo with us to get your account credentials. Here you will receive your **application** **API key**, every time you want to connect to connect to Kariz, this needs to be included in the&#x20;
